...
<div class="container">
    <div class="row">
        ...
        <?php
            ...
            {
                    $id = $_GET['id'];
                    $policy_form_data = getByID('policy_form_data',$id);
                    
                    if(mysqli_num_rows($policy_form_data) > 0)
                    {
                        $data = mysqli_fetch_array($policy_form_data);

                        ?>
                        <div class="card">
                            <div class="card-header">
                                <h4>Edit Product
                                    <a href="policy_form.php" class="btn btn-primary float-end">Back</a>
                                </h4>
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-warning" name="update_policy_form_btn">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
